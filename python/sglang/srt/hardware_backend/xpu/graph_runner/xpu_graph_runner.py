...
class XPUGraphRunner(DecodeCudaGraphRunner):
    ...
    def __init__(
        ...
        *,
        ...
        # Upstream renamed disable_piecewise_cuda_graph into cuda_graph_backend_prefill.
        # XPUGraphRunner only handles decode-phase capture; tc_piecewise prefill is
        # unsupported.
        assert model_runner.server_args.cuda_graph_backend_prefill != "tc_piecewise", (
            "XPUGraphRunner does not support tc_piecewise prefill graph yet."
        )
        assert (
